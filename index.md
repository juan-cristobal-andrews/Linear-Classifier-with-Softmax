...
As expected, we can observe that this model is only able to predict data that's linearly separable. In other words, it's unable to correctly predict non-linear shapes such as this one.
